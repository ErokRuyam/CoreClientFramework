...
class JSONSerializableTests: XCTestCase {
    ...
    func test_string_apple() {
        ...
        //Act
        let json = JSONSerializable.toJSON(m)
    ...
    func test_optionalStruct_included() {
        ...
        //Act
        let json = JSONSerializable.toJSON(cat)
    ...
    func test_prettify() {
        ...
        //Act
        let json = JSONSerializable.toJSON(m, prettify: true)
        print(json)
    ...
    func test_intArray_noIndex() {
        ...
        //Act
        let json = JSONSerializable.toJSON(m, prettify: false)
        print(json)
